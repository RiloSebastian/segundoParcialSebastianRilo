...
/** \brief rrecorre la lista y realiza una funcion utilizando un elemento de esta para aumentar o no el valor de un contador
 * \param pList LinkedList* Puntero a la lista
 * \param fn (*fn) Puntero a la funcion
 * \return LinkedList* Retorna  el valor que le devuelva (*fn)
 */
